...
void FFmpegDecoder::connect()
{
    ...
    char option_value2[]="50";
    av_dict_set(&avdic,option_key2,option_value2,0);

//    av_dict_set(&avdic, "rtsp_flags", "prefer_tcp", 0);
//    av_dict_set_int(&avdic, "buffer_size", 1000000, 0);
//    av_dict_set_int(&avdic, "rw_timeout", 5000000, 0);
//    av_dict_set_int(&avdic, "tcp_nodelay", 1, 0);
